...
import { exportDtcg } from 'neobrui/tokens.dtcg';
...
export const dtcg = exportDtcg(themes, { selectors });
```
...
Generated per-theme files are under `generated/tokens/<theme>.css` and `generated/dtcg/<theme>.json`; `generated/dtcg/manifest.json` is the product-selector sidecar. These files are build-time interchange only: runtime CSS does not fetch or load JSON, JavaScript, fonts, or images.
