...
export async function buildSizeCandidate({ outputRoot = 'dist/size-spike' } = {}) {
  ...
  const consumerTransferredCssBytes = entries.find((e) => e.name === 'consumer').minifiedBytes;
